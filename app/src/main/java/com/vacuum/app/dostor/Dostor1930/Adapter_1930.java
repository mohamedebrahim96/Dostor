 ...
 */
public class Adapter_1930 extends RecyclerView.Adapter<Adapter_1930.MyViewHolder> {
    ...
    public Adapter_1930(List<Item> items, Context mContext) {
        this.items = items;
    ...
    @Override
    public Adapter_1930.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_list, parent, false);

        return new Adapter_1930.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(Adapter_1930.MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment_1930 fragment2007 = new Fragment_1930();
