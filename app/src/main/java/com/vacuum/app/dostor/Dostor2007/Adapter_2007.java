 ...
 */
public class Adapter_2007 extends RecyclerView.Adapter<Adapter_2007.MyViewHolder> {
    ...
    public Adapter_2007(List<Item> items, Context mContext) {
        this.items = items;
    ...
    @Override
    public Adapter_2007.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_list, parent, false);

        return new Adapter_2007.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(Adapter_2007.MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment_2007 fragment2007 = new Fragment_2007();
