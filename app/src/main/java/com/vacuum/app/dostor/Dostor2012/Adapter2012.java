...
public class Adapter2012 extends RecyclerView.Adapter<Adapter2012.MyViewHolder> {
    ...
    public Adapter2012(List<Item> items, Context mContext) {
        this.mContext = mContext;
        this.items = items;
    }

    @Override
    public Adapter2012.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dostor_list_2012, parent, false);

        return new Adapter2012.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Adapter2012.MyViewHolder holder, final int position) {
