 ...
 */
public class Adapter_1923 extends RecyclerView.Adapter<Adapter_1923.MyViewHolder> {
    ...
    public Adapter_1923(List<Item> items, Context mContext) {
        this.items = items;
    ...
    @Override
    public Adapter_1923.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_list, parent, false);

        return new Adapter_1923.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(Adapter_1923.MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment_1923 fragment2007 = new Fragment_1923();
