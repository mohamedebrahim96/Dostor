...
public class Adapter1954 extends RecyclerView.Adapter<Adapter1954.MyViewHolder> {
    ...
    public Adapter1954(List<Item> items, Context mContext) {
        this.mContext = mContext;
        this.items = items;
    }

    @Override
    public Adapter1954.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dostor_list_2012, parent, false);

        return new Adapter1954.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Adapter1954.MyViewHolder holder, final int position) {
