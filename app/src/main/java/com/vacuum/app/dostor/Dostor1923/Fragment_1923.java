...
public class Fragment_1923 extends Fragment {

    RecyclerView recyclerView;
    int position;
    View view;
    Context mContext;
    Adapter1923 adapter2012;
    List<Item> items;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(position == 0)
        {
            ...
            intro_2.setText(R.string.intro_1923);
        }else if (position == 1){
    ...
    private void section_1() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_1_1923);
        String mada = " مادة ";
    ...
    private void  section_2() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_2_1923);
        String mada = " مادة ";
    ...
    private void section_3() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_3_1923);
        String mada = " مادة ";
    ...
    private void section_4() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_4_1923);
        String mada = " مادة ";
    ...
    private void section_5() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_5_1923);
        String mada = " مادة ";
    ...
    private void section_6() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_6_1923);
        String mada = " مادة ";
    ...
    private void section_7() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_7_1923);
        String mada = " مادة ";
    ...
    private void make_adapter() {
        adapter2012 = new Adapter1923(items,mContext);
