...
public class Dostor1923_Fragment extends Fragment {

    RecyclerView recyclerView;
    Adapter_1923 adapter_2012;
    ...
    private void prepareMovieData() {
       ...
       items.add(new Item("خطاب من الملك فؤاد",  R.drawable.design1));
        ...
        adapter_2012 = new Adapter_1923(items, this.getActivity());
