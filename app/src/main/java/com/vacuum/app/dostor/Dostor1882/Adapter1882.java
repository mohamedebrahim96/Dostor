...
public class Adapter1882 extends RecyclerView.Adapter<Adapter1882.MyViewHolder> {
    ...
    public Adapter1882(List<Item> items, Context mContext) {
        this.mContext = mContext;
        this.items = items;
    }

    @Override
    public Adapter1882.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dostor_list_2012, parent, false);

        return new Adapter1882.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Adapter1882.MyViewHolder holder, final int position) {
