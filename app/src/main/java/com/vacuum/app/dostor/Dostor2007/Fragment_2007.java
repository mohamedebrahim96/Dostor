...
public class Fragment_2007 extends Fragment {

    RecyclerView recyclerView;
    int position;
    View view;
    Context mContext;
    Adapter2007 adapter2012;
    List<Item> items;
    @Override
    ...
    private void section_1() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_1_2007);
        String mada = " مادة ";
    ...
    private void  section_2() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_2_2007);
        String mada = " مادة ";
    ...
    private void section_3() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_3_2007);
        String mada = " مادة ";
    ...
    private void section_4() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_4_2007);
        String mada = " مادة ";
    ...
    private void section_5() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_5_2007);
        String mada = " مادة ";
    ...
    private void section_6() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_6_2007);
        String mada = " مادة ";
    ...
    private void section_7() {
        items = new ArrayList<>();
        String x = getResources().getString(R.string.section_7_2007);
        String mada = " مادة ";
    ...
    private void make_adapter() {
        adapter2012 = new Adapter2007(items,mContext);
