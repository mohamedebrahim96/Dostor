...
public class Adapter1930 extends RecyclerView.Adapter<Adapter1930.MyViewHolder> {
    ...
    public Adapter1930(List<Item> items, Context mContext) {
        this.mContext = mContext;
        this.items = items;
    }

    @Override
    public Adapter1930.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dostor_list_2012, parent, false);

        return new Adapter1930.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Adapter1930.MyViewHolder holder, final int position) {
