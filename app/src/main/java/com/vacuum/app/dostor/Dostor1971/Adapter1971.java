...
public class Adapter1971 extends RecyclerView.Adapter<Adapter1971.MyViewHolder> {
    ...
    public Adapter1971(List<Item> items, Context mContext) {
        this.mContext = mContext;
        this.items = items;
    }

    @Override
    public Adapter1971.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dostor_list_2012, parent, false);

        return new Adapter1971.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Adapter1971.MyViewHolder holder, final int position) {
