...
public class Adapter2007 extends RecyclerView.Adapter<Adapter2007.MyViewHolder> {
    ...
    public Adapter2007(List<Item> items, Context mContext) {
        this.mContext = mContext;
        this.items = items;
    }

    @Override
    public Adapter2007.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dostor_list_2012, parent, false);

        return new Adapter2007.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Adapter2007.MyViewHolder holder, final int position) {
